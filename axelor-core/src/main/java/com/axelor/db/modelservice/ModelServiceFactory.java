...
public class ModelServiceFactory {
  ...
  public static <U extends Model> ModelService<U> resolve(
    ...
    for (String className : candidates) {
      ...
      // Se omiten interfaces — solo son válidas las clases concretas
    ...
    if (found.size() == 1) {
      ...
      // Debe tener constructor (Class<T>, Repository<T>)
    ...
    // Sin candidatos: se usa DefaultModelService
  ...
  /**
   * Calcula el paquete base para la búsqueda del servicio eliminando el segmento final {@code .db}
   * si está presente.
   *
   * <p>Ejemplos: {@code com.pkg.db} → {@code com.pkg}, {@code com.pkg} → {@code com.pkg}.
   */
